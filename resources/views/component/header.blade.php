<div class="uk-background-primary uk-sticky uk-active uk-sticky-below uk-sticky-fixed">
            ...
            <div class="uk-navbar-right">
                ...
                <div class="moduletable">
                    <ul itemprop="about" itemscope="" itemtype="http://schema.org/ItemList" class="uk-navbar-nav uk-visible@m  ">
                        <li class="gls-212" itemprop="name">
                            <a itemprop="url" href="/example">Примеры</a>
                        </li>
                        <li class="gls-206" itemprop="name">
                            <a href="/assets/uikit/tests/">Тесты</a>
                        </li>
                    </ul>
                </div>

                <div class="uk-navbar-item uk-visible@m">
                    <a target="_blank" href="https://getuikit.com/download" title="Скачать UIkit" class="uk-button uk-button-default tm-button-default uk-icon">Скачать
                        <canvas data-uk-icon="icon: download" width="20" height="20" class="uk-icon" hidden="">
                        </canvas>
