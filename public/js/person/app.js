...
var util = UIkit.util;
var search = util.$('.search-fld');
var searchVal = util.$('.search-filter');
var searchValAll = util.$('.search-filter-all');
var searchValNone = util.$('.search-filter-none');
var filterBtn = util.$$('li[data-uk-filter-control] a');
var formEl = util.$('#search-form');
var debounce, searchTerm, value; // when write on field

util.on(search, 'keyup', function () {
  ...
  debounce = setTimeout(function () {
    ...
    if (value.length) {
      ...
      util.attr(searchVal, 'data-uk-filter-control', searchTerm); // click on hidden link that gives 0 results, allow to click again filter link

      searchValNone.click(); // click hidden link that filter the search

      searchVal.click();
    } else {
      // if search field is empty
      searchTerm = '[data-tags*=""]'; // empty attribute

      util.attr(searchVal, 'data-uk-filter-control', searchTerm); // click hidden show all link
...
util.on(formEl, 'keypress', function (e) {
...
util.on(filterBtn, 'click', function () {
...
util.on(searchValNone, 'click', function (e) {
  e.preventDefault();
});

/***/ }),

/***/ "./resources/js/person/chartScripts.js":
/*!*********************************************!*\
  !*** ./resources/js/person/chartScripts.js ***!
  \*********************************************/
/***/ (() => {
...
new Chart(char4El, {
  ...
  data: {
    ...
    }, _defineProperty(_ref, "pointBorderColor", "#fff"), _defineProperty(_ref, "data", [25.48, 54.16, 7.61, 8.06, 4.45]), _ref)]
  },
  options: {
    maintainAspectRatio: false,
    responsiveAnimationDuration: 500,
...
/* harmony import */ var _cards__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./cards */ "./resources/js/person/cards.js");
/* harmony import */ var _cards__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_cards__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _chartScripts__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./chartScripts */ "./resources/js/person/chartScripts.js");
/* harmony import */ var _chartScripts__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_chartScripts__WEBPACK_IMPORTED_MODULE_3__);
